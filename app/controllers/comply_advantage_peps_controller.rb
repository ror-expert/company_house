class ComplyAdvantagePepsController < ApplicationController
  ...
  def new
    @comply_advantage_pep = ComplyAdvantagePep.new
  end
  ...
  def create
    @comply_advantage_pep = ComplyAdvantagePep.new(comply_advantage_pep_params)

    respond_to do |format|
      if @comply_advantage_pep.save
        format.html { redirect_to comply_advantage_peps_path, notice: 'Comply advantage pep was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @comply_advantage_pep.update(comply_advantage_pep_params)
        format.html { redirect_to comply_advantage_peps_path, notice: 'Comply advantage pep was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to comply_advantage_peps_path, notice: 'Comply advantage pep was successfully destroyed.' }
